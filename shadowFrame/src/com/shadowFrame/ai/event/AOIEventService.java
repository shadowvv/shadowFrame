...
import com.shadowFrame.ai.event.aoiEvent.AOIEventEnum;
...
public final class AOIEventService {
	 ...
	 * @param damage
	 */
	public static void onSceneObjectReleaseSkill(SceneObject source, SceneObject target, int skillId, int damage) {
