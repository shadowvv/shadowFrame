...
---@class LuaBehav_RuntimeTask_MonsRotateTowards : LuaBehav_RuntimeTask
...
function LuaBehav_RuntimeTask_MonsRotateTowards:OnStart()
	...
	self.__callRet = BEHAVIOR_ACTION.MonsRotateTowards(self.battleId, self.netId, self.configTask.spaceType, _vector)
end
