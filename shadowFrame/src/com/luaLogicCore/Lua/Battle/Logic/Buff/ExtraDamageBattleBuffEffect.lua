...
--- DateTime: 2022/10/10 16:27

require "Lib/class"
require "Battle/Logic/Buff/BattleBuffEffect"

---@class ExtraDamageBattleBuffEffect : BattleBuffEffect
...
ExtraDamageBattleBuffEffect = class(BattleBuffEffect, 'ExtraDamageBattleBuffEffect');

function ExtraDamageBattleBuffEffect:ctor(_buffInstanceId)
...
function ExtraDamageBattleBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum,_isUnitChangeLeader)
...
function ExtraDamageBattleBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)

end

---@public
---@return number buff类型Id
function ExtraDamageBattleBuffEffect:GetId()
    return 52;
end
...
---@return table 施法者参数
function ExtraDamageBattleBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return ExtraDamageBattleBuffEffect;