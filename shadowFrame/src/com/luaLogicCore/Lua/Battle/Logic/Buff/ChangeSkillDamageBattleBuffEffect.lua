...
--- DateTime: 2022/8/4 11:46

require "Lib/class"
require "Battle/Logic/Buff/BattleBuffEffect"

---@class ChangeSkillDamageBattleBuffEffect : BattleBuffEffect
...
ChangeSkillDamageBattleBuffEffect = class(BattleBuffEffect, 'ChangeSkillDamageBattleBuffEffect');

function ChangeSkillDamageBattleBuffEffect:ctor(_buffInstanceId)
...
function ChangeSkillDamageBattleBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum,_isUnitChangeLeader)
...
function ChangeSkillDamageBattleBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)

end

---@public
---@return number buff类型Id
function ChangeSkillDamageBattleBuffEffect:GetId()
    return 45;
end
...
---@return table 施法者参数
function ChangeSkillDamageBattleBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return ChangeSkillDamageBattleBuffEffect;