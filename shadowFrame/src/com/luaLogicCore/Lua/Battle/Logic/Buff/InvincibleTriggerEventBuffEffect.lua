...
--- DateTime: 2023/5/12 11:35

require "Lib/class"
require "Battle/Logic/Buff/BattleBuffEffect"

---@class InvincibleTriggerEventBuffEffect : BattleBuffEffect
...
InvincibleTriggerEventBuffEffect = class(BattleBuffEffect, 'InvincibleTriggerEventBuffEffect');

function InvincibleTriggerEventBuffEffect:ctor(_buffInstanceId)
...
function InvincibleTriggerEventBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum, _isUnitChangeLeader)
...
function InvincibleTriggerEventBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)

end

---@public
---@return number buff类型Id
function InvincibleTriggerEventBuffEffect:GetId()
    return 65;
end
...
---@return table 施法者参数
function InvincibleTriggerEventBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return InvincibleTriggerEventBuffEffect;