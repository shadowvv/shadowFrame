...
--- DateTime: 2023/2/23 18:18

require "Lib/class"
require "Battle/Logic/Buff/BattleBuffEffect"

---@class AllAttackHitWeakBattleBuffEffect : BattleBuffEffect
...
AllAttackHitWeakBattleBuffEffect = class(BattleBuffEffect, 'AllAttackHitWeakBattleBuffEffect');

function AllAttackHitWeakBattleBuffEffect:ctor(_buffInstanceId)
...
function AllAttackHitWeakBattleBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum,_isUnitChangeLeader)
...
function AllAttackHitWeakBattleBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)

end

---@public
---@return number buff类型Id
function AllAttackHitWeakBattleBuffEffect:GetId()
    return 60;
end
...
---@return table 施法者参数
function AllAttackHitWeakBattleBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return AllAttackHitWeakBattleBuffEffect;