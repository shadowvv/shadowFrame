...
--- DateTime: 2022/8/5 16:11

require "Lib/class"
require "Battle/Logic/Buff/BattleBuffEffect"

---@class ChangeSkillBeDamageBattleBuffEffect : BattleBuffEffect
...
ChangeSkillBeDamageBattleBuffEffect = class(BattleBuffEffect, 'ChangeSkillBeDamageBattleBuffEffect');

function ChangeSkillBeDamageBattleBuffEffect:ctor(_buffInstanceId)
...
function ChangeSkillBeDamageBattleBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum,_isUnitChangeLeader)
...
function ChangeSkillBeDamageBattleBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)

end

---@public
---@return number buff类型Id
function ChangeSkillBeDamageBattleBuffEffect:GetId()
    return 46;
end
...
---@return table 施法者参数
function ChangeSkillBeDamageBattleBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return ChangeSkillBeDamageBattleBuffEffect;