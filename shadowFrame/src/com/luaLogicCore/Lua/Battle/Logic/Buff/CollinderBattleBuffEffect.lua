...
---@class CollinderBattleBuffEffect : BattleBuffEffect
...
CollinderBattleBuffEffect = class(BattleBuffEffect, 'CollinderBattleBuffEffect');

function CollinderBattleBuffEffect:ctor(_buffInstanceId)
...
function CollinderBattleBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum, _isUnitChangeLeader)
...
function CollinderBattleBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)

end

---@public
---@return number buff类型Id
function CollinderBattleBuffEffect:GetId()
    return 66;
end
...
---@return table 施法者参数
function CollinderBattleBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return CollinderBattleBuffEffect;