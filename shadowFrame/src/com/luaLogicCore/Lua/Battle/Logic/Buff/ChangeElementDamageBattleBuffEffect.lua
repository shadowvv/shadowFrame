...
---@class ChangeElementDamageBattleBuffEffect : BattleBuffEffect
...
ChangeElementDamageBattleBuffEffect = class(BattleBuffEffect, 'ChangeElementDamageBattleBuffEffect');

function ChangeElementDamageBattleBuffEffect:ctor(_buffInstanceId)
...
function ChangeElementDamageBattleBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum,_isUnitChangeLeader)
...
function ChangeElementDamageBattleBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)

end

---@public
---@return number buff类型Id
function ChangeElementDamageBattleBuffEffect:GetId()
    return 48;
end
...
---@return table 施法者参数
function ChangeElementDamageBattleBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return ChangeElementDamageBattleBuffEffect;