...
--- DateTime: 2023/4/11 16:12

require "Lib/class"
require "Battle/Logic/Buff/BattleBuffEffect"

---@class ChangeBarrageSpeedBattleBuffEffect : BattleBuffEffect
...
ChangeBarrageSpeedBattleBuffEffect = class(BattleBuffEffect, 'ChangeBarrageSpeedBattleBuffEffect');

function ChangeBarrageSpeedBattleBuffEffect:ctor(_buffInstanceId)
...
function ChangeBarrageSpeedBattleBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum, _isUnitChangeLeader)
...
function ChangeBarrageSpeedBattleBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)

end

---@public
---@return number buff类型Id
function ChangeBarrageSpeedBattleBuffEffect:GetId()
    return 64;
end
...
---@return table 施法者参数
function ChangeBarrageSpeedBattleBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return ChangeBarrageSpeedBattleBuffEffect;