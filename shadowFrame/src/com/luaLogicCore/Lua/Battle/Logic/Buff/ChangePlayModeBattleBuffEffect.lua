...
---@class ChangePlayModeBattleBuffEffect : BattleBuffEffect
...
ChangePlayModeBattleBuffEffect = class(BattleBuffEffect, 'ChangePlayModeBattleBuffEffect');

function ChangePlayModeBattleBuffEffect:ctor(_buffInstanceId)
...
function ChangePlayModeBattleBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum,_isUnitChangeLeader)
    ...
    if playMode then
        playMode:ChangeMode(math.modf(buffAndActionTemplate.behindParam[4]));
    end
end
...
function ChangePlayModeBattleBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)
...
function ChangePlayModeBattleBuffEffect:GetId()
    return 51;
end
...
---@return table 施法者参数
function ChangePlayModeBattleBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return ChangePlayModeBattleBuffEffect;