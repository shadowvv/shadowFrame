...
--- DateTime: 2022/10/17 16:54

require "Lib/class"
require "Battle/Logic/Buff/BattleBuffEffect"

---@class ElementInvincibleBattleBuffEffect : BattleBuffEffect
...
ElementInvincibleBattleBuffEffect = class(BattleBuffEffect, 'ElementInvincibleBattleBuffEffect');

function ElementInvincibleBattleBuffEffect:ctor(_buffInstanceId)
...
function ElementInvincibleBattleBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum,_isUnitChangeLeader)
...
function ElementInvincibleBattleBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)

end

---@public
---@return number buff类型Id
function ElementInvincibleBattleBuffEffect:GetId()
    return 54;
end
...
---@return table 施法者参数
function ElementInvincibleBattleBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return ElementInvincibleBattleBuffEffect;