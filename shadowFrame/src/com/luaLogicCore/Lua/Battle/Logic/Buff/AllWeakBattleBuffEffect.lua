...
--- DateTime: 2022/12/17 15:17

require "Lib/class"
require "Battle/Logic/Buff/BattleBuffEffect"

---@class AllWeakBattleBuffEffect : BattleBuffEffect
...
AllWeakBattleBuffEffect = class(BattleBuffEffect, 'AllWeakBattleBuffEffect');

function AllWeakBattleBuffEffect:ctor(_buffInstanceId)
...
function AllWeakBattleBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum,_isUnitChangeLeader)
...
function AllWeakBattleBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)

end

---@public
---@return number buff类型Id
function AllWeakBattleBuffEffect:GetId()
    return 59;
end
...
---@return table 施法者参数
function AllWeakBattleBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return AllWeakBattleBuffEffect;