...
--- DateTime: 2022/9/27 11:49

require "Lib/class"
require "Battle/Logic/Buff/BattleBuffEffect"

---@class ChangeElementBeDamageBattleBuffEffect : BattleBuffEffect
...
ChangeElementBeDamageBattleBuffEffect = class(BattleBuffEffect, 'ChangeElementBeDamageBattleBuffEffect');

function ChangeElementBeDamageBattleBuffEffect:ctor(_buffInstanceId)
...
function ChangeElementBeDamageBattleBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum,_isUnitChangeLeader)
...
function ChangeElementBeDamageBattleBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)

end

---@public
---@return number buff类型Id
function ChangeElementBeDamageBattleBuffEffect:GetId()
    return 49;
end
...
---@return table 施法者参数
function ChangeElementBeDamageBattleBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return ChangeElementBeDamageBattleBuffEffect;