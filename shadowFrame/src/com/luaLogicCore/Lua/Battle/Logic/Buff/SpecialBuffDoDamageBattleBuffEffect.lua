...
--- DateTime: 2023/3/28 15:57

require "Lib/class"
require "Battle/Logic/Buff/BattleBuffEffect"

---@class SpecialBuffDoDamageBattleBuffEffect : BattleBuffEffect
...
SpecialBuffDoDamageBattleBuffEffect = class(BattleBuffEffect, 'SpecialBuffDoDamageBattleBuffEffect');

function SpecialBuffDoDamageBattleBuffEffect:ctor(_buffInstanceId)
...
function SpecialBuffDoDamageBattleBuffEffect:Trigger(_battleObject, _battleBuff, _stackNum, _isUnitChangeLeader)
...
function SpecialBuffDoDamageBattleBuffEffect:Release(_battleObject, _battleBuff, _stackNum, _isTimeOver)

end

---@public
---@return number buff类型Id
function SpecialBuffDoDamageBattleBuffEffect:GetId()
    return 63;
end
...
---@return table 施法者参数
function SpecialBuffDoDamageBattleBuffEffect:GenerateCostCustomParam(_battleObjectBase, _buffInstanceId, _param)
    return _param;
end

return SpecialBuffDoDamageBattleBuffEffect;