...
---@class SkillLockTargetNode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillLockTargetNode = class(SkillBaseNode, 'SkillLockTargetNode');
...
function SkillLockTargetNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillLockTargetNode:DoAction(_actionStateManager, _dt, _netId, _skillModel)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillLockTargetNode:GetType()
    return 34;
end

return SkillLockTargetNode;