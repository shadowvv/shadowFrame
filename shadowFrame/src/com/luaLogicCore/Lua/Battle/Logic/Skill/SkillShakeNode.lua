...
---@class SkillShakeNode : SkillBaseNode 技能震屏节点
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillShakeNode = class(SkillBaseNode, 'SkillShakeNode');
...
function SkillShakeNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillShakeNode:DoAction(_actionStateManager, _dt, _netId,_skillModel,_currentSkillState)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillShakeNode:GetType()
    return 8;
end

return SkillShakeNode;