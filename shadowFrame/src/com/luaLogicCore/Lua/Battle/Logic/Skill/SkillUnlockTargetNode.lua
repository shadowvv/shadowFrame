...
--- DateTime: 2022/6/17 18:25

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillUnlockTargetNode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillUnlockTargetNode = class(SkillBaseNode, 'SkillUnlockTargetNode');
...
function SkillUnlockTargetNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillUnlockTargetNode:DoAction(_actionStateManager, _dt, _netId, _skillModel)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillUnlockTargetNode:GetType()
    return 35;
end

return SkillUnlockTargetNode;