...
---@class SkillUINode : SkillBaseNode 技能UI节点
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillUINode = class(SkillBaseNode, 'SkillUINode');
...
function SkillUINode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillUINode:DoAction(_actionStateManager, _dt, _netId,_skillModel,_currentSkillState)
    local doCurrentNode = {};
