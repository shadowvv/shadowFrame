...
--- DateTime: 2022/5/6 10:06

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillBarrageEventNode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillBarrageEventNode = class(SkillBaseNode, 'SkillBarrageEventNode');
...
function SkillBarrageEventNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillBarrageEventNode:DoAction(_actionStateManager, _dt, _netId, _skillModel)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillBarrageEventNode:GetType()
    return 29;
end

return SkillBarrageEventNode;