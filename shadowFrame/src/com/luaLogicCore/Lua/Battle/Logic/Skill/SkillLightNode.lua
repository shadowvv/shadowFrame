...
--- DateTime: 2022/2/23 15:34

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillLightNode : SkillBaseNode 技能灯光节点
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillLightNode = class(SkillBaseNode, 'SkillLightNode');
...
function SkillLightNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillLightNode:DoAction(_actionStateManager, _dt, _netId,_skillModel,_currentSkillState)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillLightNode:GetType()
    return 16;
end

return SkillLightNode;