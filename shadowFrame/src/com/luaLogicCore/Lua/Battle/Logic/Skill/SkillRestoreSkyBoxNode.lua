...
--- Created by guokun
--- DateTime: 2022/11/26 11:42

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillRestoreSkyBoxNode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillRestoreSkyBoxNode = class(SkillBaseNode, 'SkillRestoreSkyBoxNode');
...
function SkillRestoreSkyBoxNode:ctor(_nodeId, _once, _nextNodes, _specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillRestoreSkyBoxNode:DoAction(_actionStateManager, _dt, _netId, _skillModel)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillRestoreSkyBoxNode:GetType()
    return 54;
end

return SkillRestoreSkyBoxNode;