...
--- DateTime: 2022/5/20 16:32

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillViewEndNode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillViewEndNode = class(SkillBaseNode, 'SkillViewEndNode');
...
function SkillViewEndNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillViewEndNode:DoAction(_actionStateManager, _dt, _netId, _skillModel)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillViewEndNode:GetType()
    return 10;
end

return SkillViewEndNode;