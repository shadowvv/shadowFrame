...
--- DateTime: 2022/11/8 16:59

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillTimelineOverNode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillTimelineOverNode = class(SkillBaseNode, 'SkillTimelineOverNode');
...
function SkillTimelineOverNode:ctor(_nodeId, _once, _nextNodes, _specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillTimelineOverNode:DoAction(_actionStateManager, _dt, _netId, _skillModel)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillTimelineOverNode:GetType()
    return 49;
end

return SkillTimelineOverNode;