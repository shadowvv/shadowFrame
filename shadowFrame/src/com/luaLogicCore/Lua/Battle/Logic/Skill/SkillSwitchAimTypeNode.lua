...
---@class SkillSwitchAimTypeNode : SkillBaseNode 技能改变瞄准类型节点
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillSwitchAimTypeNode = class(SkillBaseNode, 'SkillSwitchAimTypeNode');
...
function SkillSwitchAimTypeNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillSwitchAimTypeNode:DoAction(_actionStateManager, _dt, _netId,_skillModel,_currentSkillState)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillSwitchAimTypeNode:GetType()
    return 24;
end

return SkillSwitchAimTypeNode;