...
--- DateTime: 2022/2/23 15:24

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillUIEffectNode : SkillBaseNode 技能UI特效节点
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillUIEffectNode = class(SkillBaseNode, 'SkillUIEffectNode');
...
function SkillUIEffectNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillUIEffectNode:DoAction(_actionStateManager, _dt, _netId,_skillModel,_currentSkillState)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillUIEffectNode:GetType()
    return 30;
end

return SkillUIEffectNode;