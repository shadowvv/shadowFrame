...
---@class SkillSoundNode : SkillBaseNode 技能声音节点
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillSoundNode = class(SkillBaseNode, 'SkillSoundNode');
...
function SkillSoundNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillSoundNode:DoAction(_actionStateManager, _dt, _netId,_skillModel,_currentSkillState)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillSoundNode:GetType()
    return 7;
end

return SkillSoundNode;