...
--- DateTime: 2022/2/17 17:10

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillConditionNode : SkillBaseNode 技能条件节点
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节
SkillConditionNode = class(SkillBaseNode, 'SkillConditionNode');
...
function SkillConditionNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillConditionNode:DoAction(_actionStateManager, _dt, _netId,_skillModel,_currentSkillState)
    return true,nil;
end
...
---@public
---@return number 节点类型
function SkillConditionNode:GetType()
    return 12;
end

return SkillConditionNode;