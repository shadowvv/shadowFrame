...
--- Created by guokun
--- DateTime: 2022/12/2 10:15

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillCrosshairScaleNode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
---@field ID number id标识
SkillCrosshairScaleNode = class(SkillBaseNode, 'SkillCrosshairScaleNode');
...
function SkillCrosshairScaleNode:ctor(_nodeId, _once, _nextNodes, _specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillCrosshairScaleNode:DoAction(_actionStateManager, _dt, _netId, _skillModel)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillCrosshairScaleNode:GetType()
    return 60;
end

return SkillCrosshairScaleNode;