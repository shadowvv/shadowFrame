...
---@class SkillAnimationNode : SkillBaseNode 技能动画节点
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillAnimationNode = class(SkillBaseNode, 'SkillAnimationNode');
...
function SkillAnimationNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillAnimationNode:DoAction(_actionStateManager, _dt, _netId,_skillModel,_currentSkillState)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillAnimationNode:GetType()
    return 2;
end

return SkillAnimationNode;