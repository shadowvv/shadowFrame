...
--- DateTime: 2022/2/23 15:23

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillCameraNode : SkillBaseNode 技能摄像机节点
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillCameraNode = class(SkillBaseNode, 'SkillCameraNode');
...
function SkillCameraNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillCameraNode:DoAction(_actionStateManager, _dt, _netId,_skillModel,_currentSkillState)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillCameraNode:GetType()
    return 19;
end

return SkillCameraNode;