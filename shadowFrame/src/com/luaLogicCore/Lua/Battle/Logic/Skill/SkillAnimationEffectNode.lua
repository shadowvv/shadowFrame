...
--- DateTime: 2022/2/23 15:35

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillAnimationEffectNode : SkillBaseNode 技能动画特效节点
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillAnimationEffectNode = class(SkillBaseNode, 'SkillAnimationEffectNode');
...
function SkillAnimationEffectNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillAnimationEffectNode:DoAction(_actionStateManager, _dt, _netId,_skillModel,_currentSkillState)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillAnimationEffectNode:GetType()
    return 9;
end

return SkillAnimationEffectNode;