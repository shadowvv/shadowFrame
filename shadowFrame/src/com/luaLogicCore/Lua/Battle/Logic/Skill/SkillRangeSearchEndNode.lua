...
--- Created by guokun
--- DateTime: 2022/12/23 11:16

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillRangeSearchEndNode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
---@field ID number id标识
SkillRangeSearchEndNode = class(SkillBaseNode, 'SkillRangeSearchEndNode');
...
function SkillRangeSearchEndNode:ctor(_nodeId, _once, _nextNodes, _specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillRangeSearchEndNode:DoAction(_actionStateManager, _dt, _netId, _skillModel)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillRangeSearchEndNode:GetType()
    return 62;
end

return SkillRangeSearchEndNode;