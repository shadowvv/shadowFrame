...
--- DateTime: 2022/4/25 16:46

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillRemoveEffectNode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillRemoveEffectNode = class(SkillBaseNode, 'SkillRemoveEffectNode');
...
function SkillRemoveEffectNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillRemoveEffectNode:DoAction(_actionStateManager, _dt, _netId, _skillModel)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillRemoveEffectNode:GetType()
    return 33;
end

return SkillRemoveEffectNode;