...
--- DateTime: 2022/8/20 13:17

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillInterruptNode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillInterruptNode = class(SkillBaseNode, 'SkillInterruptNode');
...
function SkillInterruptNode:ctor(_nodeId, _once, _nextNodes, _specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillInterruptNode:DoAction(_actionStateManager, _dt, _netId, _skillModel)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillInterruptNode:GetType()
    return 43;
end

return SkillInterruptNode;