...
---@class SKillCheckCollideOverNode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SKillCheckCollideOverNode = class(SkillBaseNode, 'SKillCheckCollideOverNode');
...
function SKillCheckCollideOverNode:ctor(_nodeId, _once, _nextNodes, _specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SKillCheckCollideOverNode:DoAction(_actionStateManager, _dt, _netId, _skillModel,_currentSkillState)
    _currentSkillState.checkCollider = false;
    return true, nil;
end
...
---@public
---@return number 节点类型
function SKillCheckCollideOverNode:GetType()
    return 72;
end

return SKillCheckCollideOverNode;