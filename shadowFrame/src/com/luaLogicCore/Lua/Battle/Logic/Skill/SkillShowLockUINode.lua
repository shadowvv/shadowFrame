...
---@class SkillShowLockUINode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillShowLockUINode = class(SkillBaseNode, 'SkillShowLockUINode');
...
function SkillShowLockUINode:ctor(_nodeId, _once, _nextNodes, _specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillShowLockUINode:DoAction(_actionStateManager, _dt, _netId, _skillModel)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillShowLockUINode:GetType()
    return 44;
end

return SkillShowLockUINode;