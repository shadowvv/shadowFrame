...
--- DateTime: 2022/2/22 10:47

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillFindTargetNode : SkillBaseNode 技能寻找目标节点
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillFindTargetNode = class(SkillBaseNode, 'SkillFindTargetNode');
...
function SkillFindTargetNode:ctor(_nodeId,_once, _nextNodes,_specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillFindTargetNode:DoAction(_actionStateManager, _dt, _netId,_skillModel,_currentSkillState)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillFindTargetNode:GetType()
    return 21;
end

return SkillFindTargetNode;