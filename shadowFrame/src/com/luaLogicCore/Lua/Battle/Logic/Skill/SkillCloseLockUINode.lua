...
--- DateTime: 2022/8/23 16:55

require "Lib/class"
require "Battle/Logic/Skill/SkillBaseNode"

---@class SkillCloseLockUINode : SkillBaseNode
---@field nodeId number 节点id
---@field nextNodes SkillNodeExitData[] 子节点
SkillCloseLockUINode = class(SkillBaseNode, 'SkillCloseLockUINode');
...
function SkillCloseLockUINode:ctor(_nodeId, _once, _nextNodes, _specialExit)
    self.nodeId = _nodeId;
    self.once = _once;
...
function SkillCloseLockUINode:DoAction(_actionStateManager, _dt, _netId, _skillModel)
    local doCurrentNode = {};
...
---@public
---@return number 节点类型
function SkillCloseLockUINode:GetType()
    return 45;
end

return SkillCloseLockUINode;