...
---@class BattleLogicTriggerBattleObjectHpChangeEvent : BattleLogicEventV2
...
BattleLogicTriggerBattleObjectHpChangeEvent = class(BattleLogicEventV2, 'BattleLogicTriggerBattleObjectHpChangeEvent');
...
function BattleLogicTriggerBattleObjectHpChangeEvent:ctor(_eventType, _eventCompareParam, _eventTriggerParam, _netId, _objectId, _battleId)
...
function BattleLogicTriggerBattleObjectHpChangeEvent:CheckEventTrigger(_eventCompareParam)
    return true;
end

---事件回调，默认为空
---@public
function BattleLogicTriggerBattleObjectHpChangeEvent:FireEvent()
...
---@return boolean 是否互斥
function BattleLogicTriggerBattleObjectHpChangeEvent:CheckMutexEvent(_event)
...
return BattleLogicTriggerBattleObjectHpChangeEvent;