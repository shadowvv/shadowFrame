...
---@class BattleLogicMonsterDeadEvent : BattleLogicEventV2
...
BattleLogicMonsterDeadEvent = class(BattleLogicEventV2, 'BattleLogicMonsterDeadEvent');
...
function BattleLogicMonsterDeadEvent:ctor(_eventType, _eventCompareParam, _eventTriggerParam, _netId, _objectId, _battleId)
...
function BattleLogicMonsterDeadEvent:CheckEventTrigger(_eventCompareParam)
    return true;
end

---事件回调，默认为空
---@public
function BattleLogicMonsterDeadEvent:FireEvent()
...
---@return boolean 是否互斥
function BattleLogicMonsterDeadEvent:CheckMutexEvent(_event)
    return false;
end

---检测移除事件，默认事件会在trigger之后的下一帧被移除
---@public
function BattleLogicMonsterDeadEvent:CheckRemoveEvent()
...
---生成比较参数
---@public
function BattleLogicMonsterDeadEvent:GenerateCompareParam(_param);
    local compareParam = {};
    return compareParam;
end

return BattleLogicMonsterDeadEvent;