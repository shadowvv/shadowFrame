...
---@class BattleLogicAllProtectTargetUnitDeadEvent : BattleLogicEventV2
...
BattleLogicAllProtectTargetUnitDeadEvent = class(BattleLogicEventV2, 'BattleLogicAllProtectTargetUnitDeadEvent');
...
function BattleLogicAllProtectTargetUnitDeadEvent:ctor(_eventType, _eventCompareParam, _eventTriggerParam, _netId, _objectId, _battleId)
...
function BattleLogicAllProtectTargetUnitDeadEvent:CheckEventTrigger(_eventCompareParam)
    return true;
end

---事件回调，默认为空
---@public
function BattleLogicAllProtectTargetUnitDeadEvent:FireEvent()
...
---@return boolean 是否互斥
function BattleLogicAllProtectTargetUnitDeadEvent:CheckMutexEvent(_event)
    return false;
end

---检测移除事件，默认事件会在trigger之后的下一帧被移除
---@public
function BattleLogicAllProtectTargetUnitDeadEvent:CheckRemoveEvent()
...
---生成比较参数
---@public
function BattleLogicAllProtectTargetUnitDeadEvent:GenerateCompareParam(_param);
    local compareParam = {};
    return compareParam;
end

return BattleLogicAllProtectTargetUnitDeadEvent;