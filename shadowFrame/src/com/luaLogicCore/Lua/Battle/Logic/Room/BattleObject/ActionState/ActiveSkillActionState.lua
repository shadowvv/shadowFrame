...
---@class ActiveSkillActionState : table
...
ActiveSkillActionState = class(SkillActionState, 'ActiveSkillActionState');
...
function ActiveSkillActionState:ctor(_battleId, _stateParamId, _unitType, _skillId, _objectId)
...
function ActiveSkillActionState:GetId()
    return 20;
end

return ActiveSkillActionState;