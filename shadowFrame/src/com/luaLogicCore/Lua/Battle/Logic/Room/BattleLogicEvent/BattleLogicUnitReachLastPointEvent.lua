...
---@class BattleLogicUnitReachLastPointEvent : BattleLogicEventV2
...
BattleLogicUnitReachLastPointEvent = class(BattleLogicEventV2, 'BattleLogicUnitReachLastPointEvent');
...
function BattleLogicUnitReachLastPointEvent:ctor(_eventType, _eventCompareParam, _eventTriggerParam, _netId, _objectId, _battleId)
...
function BattleLogicUnitReachLastPointEvent:CheckEventTrigger(_eventCompareParam)
    return self.eventCompareParam.netId == _eventCompareParam.netId;
end

---事件回调，默认为空
---@public
function BattleLogicUnitReachLastPointEvent:FireEvent()
...
---@return boolean 是否互斥
function BattleLogicUnitReachLastPointEvent:CheckMutexEvent(_event)
    return false;
end

---检测移除事件，默认事件会在trigger之后的下一帧被移除
---@public
function BattleLogicUnitReachLastPointEvent:CheckRemoveEvent()
...
---生成比较参数
---@public
function BattleLogicUnitReachLastPointEvent:GenerateCompareParam(_param);
    local compareParam = {};
    return compareParam;
end

return BattleLogicUnitReachLastPointEvent;