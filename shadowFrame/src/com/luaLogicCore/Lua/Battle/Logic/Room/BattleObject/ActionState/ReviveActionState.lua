...
function ReviveActionState:EnterAction(_actionStateManager)
    self.runTime = 0;
    return true;
end
...
function ReviveActionState:DoAction(_actionStateManager, _dt, _netId, _objId)
...
function ReviveActionState:ExitAction(_actionStateManager,_isBreak,_isActive)

end

-- 是否为主动状态
---@return boolean 是否为主动状态
function ReviveActionState:IsActive()
    return true;
end

-- 行为状态Id
---@return number 行为状态Id 参照stateSwitchRule表
function ReviveActionState:GetId()
    return 12;
end

---获得状态冲突表
---@return StateSwitchRule
function ReviveActionState:GetSwitchRule()
    return self.battleRoom.inputDataSource:GetDict("StateSwitchRule",self:GetId());
end

return ReviveActionState;