...
---@class BattleLogicAllBossUnitDeadEvent : BattleLogicEventV2
...
BattleLogicAllBossUnitDeadEvent = class(BattleLogicEventV2, 'BattleLogicAllBossUnitDeadEvent');
...
function BattleLogicAllBossUnitDeadEvent:ctor(_eventType, _eventCompareParam, _eventTriggerParam, _netId, _objectId, _battleId, _battleId)
...
function BattleLogicAllBossUnitDeadEvent:CheckEventTrigger(_eventCompareParam)
    return true;
end

---事件回调，默认为空
---@public
function BattleLogicAllBossUnitDeadEvent:FireEvent()
...
---@return boolean 是否互斥
function BattleLogicAllBossUnitDeadEvent:CheckMutexEvent(_event)
    return false;
end

---检测移除事件，默认事件会在trigger之后的下一帧被移除
---@public
function BattleLogicAllBossUnitDeadEvent:CheckRemoveEvent()
...
---生成比较参数
---@public
function BattleLogicAllBossUnitDeadEvent:GenerateCompareParam(_param);
    local compareParam = {};
    return compareParam;
end

return BattleLogicAllBossUnitDeadEvent;