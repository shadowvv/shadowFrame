...
---@class BattleLogicAllKeyUnitDeadEvent : BattleLogicEventV2
...
BattleLogicAllKeyUnitDeadEvent = class(BattleLogicEventV2, 'BattleLogicAllKeyUnitDeadEvent');
...
function BattleLogicAllKeyUnitDeadEvent:ctor(_eventType, _eventCompareParam, _eventTriggerParam, _netId, _objectId, _battleId, _battleId)
...
function BattleLogicAllKeyUnitDeadEvent:CheckEventTrigger(_eventCompareParam)
    return true;
end

---事件回调，默认为空
---@public
function BattleLogicAllKeyUnitDeadEvent:FireEvent()
...
---@return boolean 是否互斥
function BattleLogicAllKeyUnitDeadEvent:CheckMutexEvent(_event)
    return false;
end

---检测移除事件，默认事件会在trigger之后的下一帧被移除
---@public
function BattleLogicAllKeyUnitDeadEvent:CheckRemoveEvent()
...
---生成比较参数
---@public
function BattleLogicAllKeyUnitDeadEvent:GenerateCompareParam(_param);
    local compareParam = {};
    return compareParam;
end

return BattleLogicAllKeyUnitDeadEvent;