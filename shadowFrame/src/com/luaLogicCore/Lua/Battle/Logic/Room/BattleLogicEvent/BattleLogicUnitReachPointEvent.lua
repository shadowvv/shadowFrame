...
---@class BattleLogicUnitReachPointEvent : BattleLogicEventV2
...
BattleLogicUnitReachPointEvent = class(BattleLogicEventV2, 'BattleLogicUnitReachPointEvent');
...
function BattleLogicUnitReachPointEvent:ctor(_eventType, _eventCompareParam, _eventTriggerParam, _netId, _objectId, _battleId)
...
function BattleLogicUnitReachPointEvent:CheckEventTrigger(_eventCompareParam)
    return true;
end

---事件回调，默认为空
---@public
function BattleLogicUnitReachPointEvent:FireEvent()
...
---@return boolean 是否互斥
function BattleLogicUnitReachPointEvent:CheckMutexEvent(_event)
    return false;
end

---检测移除事件，默认事件会在trigger之后的下一帧被移除
---@public
function BattleLogicUnitReachPointEvent:CheckRemoveEvent()
...
---生成比较参数
---@public
function BattleLogicUnitReachPointEvent:GenerateCompareParam(_param);
    local compareParam = {};
    return compareParam;
end

return BattleLogicUnitReachPointEvent;