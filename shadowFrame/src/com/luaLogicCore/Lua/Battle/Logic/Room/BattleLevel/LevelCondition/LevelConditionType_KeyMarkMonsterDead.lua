...
---@class LevelConditionType_KeyMarkMonsterDead : LevelConditionType
---@field id number
---@field event number
...
LevelConditionType_KeyMarkMonsterDead = class(LevelConditionType, 'LevelConditionType_KeyMarkMonsterDead');
...
function LevelConditionType_KeyMarkMonsterDead:GetCheckLastMonsterLevelUnitIds(_checkLastMonsterLevelUnitIds, _levelCondition, _battleId)
    -- 全部关键怪物
    local _battleRoom = GetBattleRoom(_battleId)
    local _keyUnits = _battleRoom.battleLevelManager.levelUnitManager:GetKeyLevelUnit()
...
return LevelConditionType_KeyMarkMonsterDead;
