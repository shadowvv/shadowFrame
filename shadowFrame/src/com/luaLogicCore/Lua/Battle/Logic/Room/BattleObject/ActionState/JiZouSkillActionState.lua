...
---@class JiZouSkillActionState : table
...
JiZouSkillActionState = class(SkillActionState, 'JiZouSkillActionState');
...
function JiZouSkillActionState:ctor(_battleId, _stateParamId, _unitType, _skillId, _objectId)
...
function JiZouSkillActionState:GetId()
    return 21;
end

return JiZouSkillActionState;