...
---@class BattleLogicReloadEndEvent : BattleLogicEventV2
...
BattleLogicReloadEndEvent = class(BattleLogicEventV2, 'BattleLogicReloadEndEvent');
...
function BattleLogicReloadEndEvent:ctor(_eventType, _eventCompareParam, _eventTriggerParam, _netId, _objectId, _battleId)
...
function BattleLogicReloadEndEvent:CheckEventTrigger(_eventCompareParam)
    return _eventCompareParam.isBreak == nil or _eventCompareParam.isBreak == self.eventCompareParam.isBreak;
end

---事件回调，默认为空
---@public
function BattleLogicReloadEndEvent:FireEvent()
...
---@return boolean 是否互斥
function BattleLogicReloadEndEvent:CheckMutexEvent(_event)
    return false;
end

---检测移除事件，默认事件会在trigger之后的下一帧被移除
---@public
function BattleLogicReloadEndEvent:CheckRemoveEvent()
...
return BattleLogicReloadEndEvent;